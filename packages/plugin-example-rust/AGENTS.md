...
- The example config targets `**/*.rs` as `plaintext`; it does not provide a Rust AST extractor, Cargo metadata reader, compiler-aware symbol graph, or concrete rules yet.
